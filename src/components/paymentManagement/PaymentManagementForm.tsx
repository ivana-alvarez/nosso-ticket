...
const PaymentManagement= () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit, onInvalid)}>
            ...
            <Grid container spacing={2} sx={{ marginTop: '20px', marginLeft:1 }}>
                <Grid item xs={12}>
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        ...
                        >
                            <label htmlFor="Id del usuario">Titular de la cuenta </label>
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <Grid
                            ...
                            className={classes.searchControl}
                        >
                            <label htmlFor="">{payment.account_holder} </label>
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <Grid
                            ...
                            className={classes.searchControl}
                        >
                            <label htmlFor="">{payment.identification}</label>
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <Grid
                            ...
                            className={classes.searchControl}
                        >
                            <label htmlFor="">{payment.operation}</label>
